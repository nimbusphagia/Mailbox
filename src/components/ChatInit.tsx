...
export function ChatInit({ contact, createdAt }: Props) {
  ...
  return (
    <div
      className="flex flex-col gap-5 items-center w-fit max-w-[100%] p-6 bg-fg1/65 rounded-sm m-auto my-6 shadow-md">
      ...
      <div className="text-center font-bold flex flex-col gap-1">
        <pre className="select-none text-[0.36em] text-bg1 font-black leading-none">
          {loading ? title : ascii}
        </pre>
